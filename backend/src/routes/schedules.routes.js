...
// GET /schedules
router.get("/",
verificarToken, tienePermiso("horarios.ver"),
async (req, res) => {
    try {
...
// POST /schedules
router.post("/",
verificarToken, tienePermiso("horarios.crear"),
async (req, res) => {
    try {
...
// PUT /schedules/:employeeId/:weekStartDate
router.put("/:employeeId/:weekStartDate",
verificarToken, tienePermiso("horarios.editar"),
async (req, res) => {
    try {
...
router.delete("/:employeeId/:weekStartDate",
verificarToken, tienePermiso("horarios.eliminar"),
async (req, res) => {
    try {
    const { employeeId, weekStartDate } = req.params;
    const monday = new Date(weekStartDate + "T00:00:00");
